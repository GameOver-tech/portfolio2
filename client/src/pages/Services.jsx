      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionReveal type="blur"><div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h1 className="text-[clamp(2rem,7vw,2.8rem)] sm:text-4xl md:text-6xl font-heading font-bold mt-4 mb-6 text-text-primary">{content.services_heading || 'What I'} <span className="text-gradient">{content.services_heading_highlight || 'Deliver'}</span></h1>
            <p className="leading-relaxed text-text-muted">{content.services_description || 'Production-ready AI systems and software built for reliability, scale, and business impact.'}</p>
          </div></SectionReveal>
              ...
              <motion.div key={service.id || i} variants={staggerItemScale}>
                <motion.div whileHover={{ y: -6, scale: 1.02 }}
                  ...
                  <div className="relative">
                    ...
                    <div className="flex items-center space-x-2 text-accent text-sm font-medium opacity-0 group-hover:opacity-100 transition-opacity duration-500"><span>{content.services_learn_more || 'Learn More'}</span><FiArrowRight className="group-hover:translate-x-1 transition-transform" /></div>
                  </div>
      ...
      <section className="py-20 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionReveal type="scale"><div className="text-center mb-16">
            ...
            <h2 className="text-[clamp(2rem,7vw,2.5rem)] sm:text-4xl md:text-5xl font-heading font-bold mt-4 text-text-primary">{content.process_heading || 'My Development'} <span className="text-gradient">{content.process_heading_highlight || 'Process'}</span></h2>
          </div></SectionReveal>
